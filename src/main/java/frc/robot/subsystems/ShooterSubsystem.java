...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public boolean isShooterAtSpeed(double targetVelocity) {
        double currentVelocity = shooter.getCachedVelocityRps() * Constants.Shooter.Rollers.MOTOR_ROTS_PER_WHEEL_ROT;
        return ((currentVelocity - targetVelocity <= 1.0) || (targetVelocity - currentVelocity <= 1.0));
    }
