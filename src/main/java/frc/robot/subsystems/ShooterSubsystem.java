...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public boolean isShooterAtSpeed() {
    ...
    return Math.abs(current_vel - targetRollerSpeed) <= 1.0;
  }

  // Shoot Command

  public Command shootWithHood(DoubleSupplier targetSpeed, DoubleSupplier targetAngle) {
    return runEnd(
        () -> {
          setShooterSpeed(targetSpeed.getAsDouble());
          setHoodAngle(targetAngle.getAsDouble());
        },
        this::stopShooter);
  }
}
