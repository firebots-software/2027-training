...
public final class Constants {
    ...
    public static final class Intake {
        ...
        public static final class Arm {
            ...
            public static final double MOTOR_ROTS_PER_ARM_ROT = (12.0 / 1.0) * (42.0 / 36.0) * (30.0 / 18.0)
                    * (32.0 / 20.0);
        ...
        public static final class Rollers {
            ...
            public static final double DESIGNED_SURFACE_SPEED_METERS_PER_SEC = DESIGNED_SURFACE_SPEED_FT_PER_SEC
                    * 0.3048;
    ...
    public static final class Shooter {
        ...
        public static final InterpolatingDoubleTreeMap ROLLER_SPEED_MAP = new InterpolatingDoubleTreeMap();
        public static final InterpolatingDoubleTreeMap TIME_OF_FLIGHT_MAP = new InterpolatingDoubleTreeMap();

        public static final InterpolatingDoubleTreeMap PASSING_ROLLER_SPEED_MAP = new InterpolatingDoubleTreeMap();
