...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    joystick
        ...
        .whileTrue(
            shooterSubsystem
                .shootWithHood(44.2, Constants.Shooter.Hood.MIN_HOOD_ANGLE)
                .alongWith(
    ...
    joystick
        ...
        .whileTrue(
            shooterSubsystem
                .shootWithHood(58.2, Constants.Shooter.Hood.MAX_HOOD_ANGLE)
                .alongWith(
                    Commands.waitUntil(shooterSubsystem::isSho
                    oterAtSpeed)
                        .andThen(hopperSubsystem.runHopperUntilInterruptedCommand())));
  }
